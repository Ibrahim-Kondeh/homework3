                                ...
                                <td><?php echo $team['home_stadium']; ?></td>
                                 ...
                                 <td>
                                    <form method ="post" action ="">
                                        <input type="hidden" name="teamId" value="<?php echo $team['team_id']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to delete this team?');">
