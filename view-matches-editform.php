        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" action="">
                    ...
                    <button type="submit" class="btn btn-primary" name="updateMatch">Update Match</button>
                </form>
            </div>
        </div>
    </div>
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['updateMatch'])) {
    ...
    $selectedCompetitionId = $_POST['matchId'];
    $selectedTeam1Id = $_POST['team1Id'];
    $selectedTeam2Id = $_POST['team2Id'];
    $selectedMatchDate = $_POST['matchDate'];
    $selectedScore1 = $_POST['score1'];
    $selectedScore2 = $_POST['score2'];

    // Update match in the database
    $updateSuccess = updateMatches($selectedMatchId, $selectedTeam1Id, $selectedTeam2Id, $selectedMatchDate, $selectedScore1, $selectedScore2);

    // Provide feedback to the user
    if ($updateSuccess) {
        echo '<div class="alert alert-success mt-3" role="alert">Match updated successfully!</div>';
    } else {
        echo '<div class="alert alert-danger mt-3" role="alert">Failed to update match. Please try again.</div>';
    }
}
?>
